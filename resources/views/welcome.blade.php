      ...
      <div class="modal-content">
           <div class="content">
                ...
                <div class="field">
                     ...
                     {{-- <input class="input" placeholder="Departamento" v-model="titleDeparture" v-if="modalDeparture==1 || modalDeparture==2">
                    ...
                    case "departure":
                    {
                        switch (action) {
                            ...
                            case 'update':
                            {
                                ...
                                this.messageModal = 'Modifique el título del departamento';
                ...
                axios.post('{{route('employeecreate')}}', {
                    ...
                    .catch(function (error) {
                        ...
                        if (error.response && error.response.status === 422) {
                            me.errorEmployee = 1;
                            error.response.data.errors.email.forEach(function (element) {
            ...
            updateEmployee() {
                ...
                axios.put('{{route('employeeupdate')}}', {
                    ...
                    .catch(function (error) {
                        ...
                        if (error.response && error.response.status === 422) {
                            me.errorEmployee = 1;
                            me.errorMessageEmployee = error.response.data.errors.email;
                            console.clear();
                        } else {
                            console.log(error);
                        }
